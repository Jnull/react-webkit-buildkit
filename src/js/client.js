...
const MainNavLayout = ({match}) => (
    <div>
        ...
        <ul>
            ...
            <li>
                <Link to="/person/netflix">Bob Hope</Link>
            </li>
            <li>
                <Link to="/person/zillow-group">Charlie</Link>
            </li>
            <li>
                <Link to="/company/yahoo">Yahoo</Link>
            </li>
            <li>
                <Link to="/company/modus-create">Modus Create</Link>
            </li>
        </ul>
    </div>
)
